...
const ProductCard = ({ item, onAddToCart }: ProductCardProps) => {
  ...
  return (
    ...
    >
      <Card className="group hover:shadow-lg hover:shadow-blue-100/50 transition-all duration-300 relative overflow-visible hover:-translate-y-1">
        <CardContent className="p-0">
          ...
          <div className="relative overflow-hidden rounded-t-lg">
            ...
            <Badge 
              variant="secondary" 
              className="absolute top-2 left-2 bg-white/90 text-gray-700 backdrop-blur-sm transition-all duration-200 group-hover:bg-white group-hover:shadow-md"
            >
            ...
            <div className="absolute top-2 right-2 flex flex-wrap gap-1 max-w-20">
              {storesToShow.map((store, index) => (
                <div
                  ...
                  className="w-6 h-6 rounded-full bg-white shadow-sm border border-gray-200 overflow-hidden flex items-center justify-center p-0.5 transition-all duration-200 group-hover:shadow-md group-hover:scale-110"
              ...
              {remainingCount > 0 && (
                <button 
                  ...
                  className="w-6 h-6 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 shadow-sm border border-gray-200 flex items-center justify-center hover:from-blue-600 hover:to-purple-700 transition-all duration-200 group-hover:shadow-md group-hover:scale-110"
            ...
            {showAllStores && (
              <div 
                ref={dropdownRef}
                className="absolute top-10 right-2 bg-white rounded-lg shadow-xl border border-gray-200 p-2 z-50 min-w-24 animate-in fade-in-0 zoom-in-95 duration-200"
              >
          ...
          <div className="p-4">
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex-1">
                <p className="text-lg font-bold text-green-600 group-hover:text-green-700 transition-colors duration-200">
            ...
            <Button
              size="sm"
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-2.5 rounded-md transition-all duration-200 hover:shadow-lg hover:shadow-blue-200/50 transform hover:scale-[1.02]"
